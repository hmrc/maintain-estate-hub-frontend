...
class ErrorHandlerSpec extends SpecBase {
  ...
  private val errorHandler: ErrorHandler =
    new ErrorHandler(messageApi, errorTemplate)
  ...
  "ErrorHandler" must {
    ...
    "return an internal server error template" in {
      ...
      val pageNotFoundTitle     = Messages("problemWithService.title")(messages)
      val internalErrorMessage1 = Messages("problemDeclaring.p1")(messages)

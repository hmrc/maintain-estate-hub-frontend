...
class ProblemDeclaringControllerSpec extends SpecBase {

  "Problem declaring Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val request = FakeRequest(GET, routes.ProblemDeclaringController.onPageLoad().url)
